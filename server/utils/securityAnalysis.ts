 ...
 */
export function parseCapabilities(capabilities: string | null): SecurityAnalysis {
 ...
 */
export function explainSecurityTerm(term: string): string {
 ...
 */
export function categorizeNetworksBySecurity(networks: Array<{ capabilities: string | null }>) {
  const categories = {
