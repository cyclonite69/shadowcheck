...
export class DatabaseStorage implements IStorage {
  ...
  // FIXED: Updated getRadioStats to use app.networks_legacy with proper type filtering
        ...
        WITH radio_type_mapping AS (
          SELECT
            CASE 
              ...
              WHEN type IN ('C', 'G', 'L', 'N') THEN 'cellular'
              WHEN type = 'D' THEN 'dect'
              WHEN type = 'T' THEN 'transmitter'
              ELSE 'unknown'
            END as radio_type,
            COUNT(*) as count,
...
export const storage = new DatabaseStorage();y;
