...
import { Map, Filter, MapPin, Activity } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
    ...
    map.current.addLayer({
      ...
      paint: {
        ...
        'circle-color': [
          'case',
          ['==', ['get', 'radio_type'], 'wifi'],
          '#22c55e', // Muted green for WiFi
          ['==', ['get', 'radio_type'], 'ble'],
          '#8b5cf6', // Muted purple for BLE
          ['==', ['get', 'radio_type'], 'bluetooth'],
          '#3b82f6', // Muted blue for Bluetooth
          ['==', ['get', 'radio_type'], 'cellular'],
          '#dc2626', // Muted red for Cellular
          '#6b7280', // Muted gray for unknown
        ],
        'circle-stroke-width': [
          'case',
          ['==', ['get', 'security_level'], 'high'],
          2, // Thick border for high security
          ['==', ['get', 'security_level'], 'medium'],
          1.5, // Medium border
          ['==', ['get', 'security_level'], 'low'],
          1, // Thin border for low security
          ['==', ['get', 'security_level'], 'none'],
          3, // Very thick border for open networks
          1, // Default
        ],
        'circle-stroke-color': [
          'case',
          ['==', ['get', 'security_level'], 'high'],
          '#16a34a', // Muted green for high security
          ['==', ['get', 'security_level'], 'medium'],
          '#ca8a04', // Muted yellow for medium
          ['==', ['get', 'security_level'], 'low'],
          '#ea580c', // Muted orange for low
          ['==', ['get', 'security_level'], 'none'],
          '#dc2626', // Muted red for open
