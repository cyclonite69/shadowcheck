            ...
            <CardContent className='relative p-8'>
              <div className='flex items-start justify-between'>
                <div className='flex items-center gap-4'>
                  ...
                  <div>
                    <p
                      className='text-4xl metric-value mb-2'
                    ...
                    <div className='flex items-center gap-3'>
                      <div
                        className={`w-3 h-3 rounded-full ${
                          item.security?.includes('WPA3')
                            ? 'bg-green-500'
                            : item.security?.includes('WPA2')
                              ? 'bg-blue-500'
                              : item.security?.includes('WPA')
                                ? 'bg-yellow-500'
                                : item.security?.includes('WEP')
                                  ? 'bg-orange-500'
                                  : item.security === '[ESS]' || !item.security
                                    ? 'bg-red-500'
                                    : 'bg-gray-500'
                        }`}
                      ></div>
                    ...
                    <Pie
                      data={[
                        { name: 'WiFi Networks', value: wifiStats.observations, color: '#3b82f6' },
                        {
                          ...
                          value: cellularStats.observations,
                          color: '#10b981',
                        },
                        {
                          name: 'Bluetooth Devices',
                          value: bluetoothStats.observations,
                          color: '#a855f7',
                        },
                ...
                <CardHeader className='relative p-8'>
                  <div className='flex flex-col items-center text-center space-y-4'>
                    ...
                    <div>
                      ...
                      <CardDescription className='text-slate-400'>
                        Geospatial mapping and analysis tools with Mapbox integration for forensics
                        data
                      </CardDescription>
                    </div>
                  </div>
