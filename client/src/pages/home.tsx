...
const features = [
  {
    ...
    description:
      'Advanced SIGINT collection and analysis of wireless communications and RF signatures.',
  ...
  },
  {
    ...
    description:
      'Military-grade mapping with PostGIS spatial analysis for forensic investigations.',
  ...
  },
  {
    ...
    description:
      'Multi-spectrum monitoring for cellular, WiFi, Bluetooth, and BLE device detection.',
  ...
  },
  {
    ...
    description:
      'Comprehensive intelligence database with advanced correlation and pattern analysis.',
        ...
        <div className='relative max-w-7xl mx-auto px-6 py-24 lg:py-32'>
          <div className='text-center'>
            ...
            <div className='inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/50 border border-slate-700 mb-8 cyber-glow cyber-scan-line'>
              <Badge
                variant='secondary'
                className='bg-blue-500/20 text-blue-300 border-blue-500/30 cyber-hexagon'
              >
                New
              </Badge>
              <span className='text-sm text-slate-300 cyber-text'>
                Advanced spatial queries now available
              </span>
            ...
            <h1 className='text-4xl sm:text-5xl lg:text-7xl font-bold mb-8 leading-tight'>
              <span className='hero-gradient-text block mb-2'>Better Context.</span>
              <span
                className='feature-gradient-text glitch-text block mb-2'
                data-text='Better Intelligence.'
              >
                Better Intelligence.
              </span>
              <span className='hero-gradient-text block'>Better Analysis.</span>
            </h1>

            <p className='text-xl text-slate-400 max-w-3xl mx-auto mb-12 leading-relaxed'>
              The most powerful SIGINT forensics platform backed by the industry-leading spatial
              intelligence engine. Advanced wireless network analysis for security professionals.
            </p>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-4'>
              <div className='premium-card cyber-border data-stream hover:scale-105'>
                <CardContent className='p-8 text-center'>
                  ...
                  <p className='text-slate-300 cyber-text'>
                    Real-time signal intelligence metrics with advanced data correlation
                  </p>
              ...
              <div className='premium-card cyber-border data-stream hover:scale-105'>
                <CardContent className='p-8 text-center'>
                  ...
                  <p className='text-slate-300 cyber-text'>
                    Multi-spectrum surveillance and RF signature analysis
                  </p>
                  <div className='mt-4 silver-accent px-4 py-2 rounded-full inline-block'>
              ...
              <div className='premium-card cyber-border data-stream hover:scale-105'>
                <CardContent className='p-8 text-center'>
                  ...
                  <p className='text-slate-300 cyber-text'>
                    Advanced pattern recognition and threat assessment
                  </p>
        ...
        <div className='max-w-7xl mx-auto px-6'>
          ...
          <div className='flex flex-wrap justify-center items-center gap-8'>
            {trustedByLogos.map((logo, index) => (
              <div
                key={index}
                className='text-slate-400 font-medium text-sm px-4 py-2 bg-slate-800/30 rounded-lg border border-slate-700'
              >
                {logo}
              </div>
            ))}
        ...
        <div className='max-w-7xl mx-auto px-6'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-slate-400 max-w-3xl mx-auto'>
              Proprietary spatial analysis combined with cutting-edge forensics capabilities give
              you intelligence you can trust for critical operations.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
            <div className='text-center group'>
              <div className='premium-card hover:scale-105 p-8'>
                ...
                <p className='text-slate-300'>
                  Monitor wireless networks and cellular signals in real-time with advanced
            ...
            <div className='text-center group'>
              <div className='premium-card hover:scale-105 p-8'>
                ...
                <p className='text-slate-300'>
                  Comprehensive SIGINT analysis including WiFi, Bluetooth, BLE, and cellular data
                  collection.
                </p>
              </div>
            </div>
            ...
            <div className='text-center group'>
              <div className='premium-card hover:scale-105 p-8'>
                ...
                <p className='text-slate-300'>
                  Your intelligence data is secure and private by default with enterprise-grade
                  encryption.
                </p>
              </div>
            </div>
