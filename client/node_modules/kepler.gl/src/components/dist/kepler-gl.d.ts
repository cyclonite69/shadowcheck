...
export declare const plotContainerSelector: (props: KeplerGLProps) => {
    ...
    ratio: "CUSTOM" | "SCREEN" | "FOUR_BY_THREE" | "SIXTEEN_BY_NINE";
    ...
    setExportImageSetting: (newSetting: Partial<import("@kepler.gl/types").ExportImage>) => {
        payload: Partial<import("@kepler.gl/types").ExportImage>;
