...
var _src3 = require("/Users/ihordykhta/Desktop/unfolded/kepler.gl/src/components/src");
...
function AiAssistantPanel() {
  ...
  var combinedMessages = (0, _react.useMemo)(function () {
    return Object.keys(_localization.messages).reduce(function (acc, language) {
      return _objectSpread(_objectSpread({}, acc), {}, (0, _defineProperty2["default"])({}, language, _objectSpread(_objectSpread({}, _localization.messages[language] || {}), _src2.messages[language] || {})));
    }, {});
  }, []);
  return /*#__PURE__*/_react["default"].createElement(_reactIntl.IntlProvider, {
    locale: locale,
    messages: (0, _src.flattenMessages)(combinedMessages[locale])
    ...
    title: "AI Assistant"
  }, /*#__PURE__*/_react["default"].createElement(_src3.Icons.Settings, {
